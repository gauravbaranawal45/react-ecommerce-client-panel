...
class productDetail extends Component {
  ...
  componentDidMount = () => {
    let pid = queryString.parse(this.props.location.search).pid;
                  ...
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <div class="simpleLens-big-image-container"><a data-lens-image={process.env.PUBLIC_URL + '/assets/img/view-slider/large/polo-shirt-1.png'} class="simpleLens-lens-image">
                        <img src={process.env.PUBLIC_URL + '/assets/img/view-slider/medium/polo-shirt-1.png'} class="simpleLens-big-image"/></a></div>
                      </div>
